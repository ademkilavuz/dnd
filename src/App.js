...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      canvaswidth: 1000,
      canvasheight: 600,
      defaultbg: require("./images/silver.jpg"),
              ...
              >
                <ul className="navbar-nav ml-md-auto">
                  <li className="nav-item active download">
                    {" "}
                    <a className="btn btn-primary headerbtn">UNDO</a>{" "}
                  </li>
                  <li className="nav-item active download">
                    {" "}
                    <a className="btn btn-primary headerbtn">REDO</a>{" "}
                  </li>
                  ...
                  <li className="nav-item active download">
                    {" "}
                    <a className="btn btn-primary headerbtn">LOGOUT</a>{" "}
                  </li>
                </ul>
              </div>
            </nav>
              ...
              <TabList>
                ...
                >
                  <div className="edit-box1">
                    <h1>
                      <img
                        src={require("./images/icon-background.png")}
                        alt=""
                      />
                    </h1>
                ...
                <Tab tabFor="vertical-tab-three" className="lasttab">
                  <div className="edit-box2">
                    <h1>
                      <img src={require("./images/icon-picture.png")} alt="" />
                    </h1>
                    <span>Buttons</span>
                  </div>
                </Tab>
                <Tab tabFor="vertical-tab-four" className="lasttab">
                  <div className="edit-box3">
                    <h1>
                      <img src={require("./images/icon-Text.png")} alt="" />
                    </h1>
                    <span>TEXT</span>
                  </div>
                </Tab>
